...
def save_attendance(member_name, week_key):
    """寫入單筆或多筆簽到資料"""
...
# ==========================================
    ...
    # 讓使用者選擇要查詢的週數 (第 1 週到第 43 週)
    selected_week_num = st.selectbox("請選擇欲查詢的週數：", list(range(1, 44)), index=31) # 預設選第 32 週
